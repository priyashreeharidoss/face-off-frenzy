...
$sql = "SELECT question, option1, option2, option3, option4, correct FROM round1_question";
...
<script>
    ...
    var url = "success1.php?username=" + encodeURIComponent(username) + "&loginid=" + encodeURIComponent(loginid) + "&marks=" + marks;
