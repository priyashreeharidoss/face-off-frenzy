...
$sql = "SELECT question, option1, option2, option3, option4, correct FROM round2_question";
...
<script>
    ...
    var url = "success2.php?username=" + encodeURIComponent(username) + "&loginid=" + encodeURIComponent(loginid) + "&marks=" + marks;
