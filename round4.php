...
$sql = "SELECT question, option1, option2, option3, option4, correct FROM round4_question";
...
<script>
    ...
    var url = "success4.php?username=" + encodeURIComponent(username) + "&loginid=" + encodeURIComponent(loginid) + "&marks=" + marks;
